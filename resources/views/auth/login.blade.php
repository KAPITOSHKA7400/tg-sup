...
@section('content')
    <div class="max-w-md w-full mx-auto mt-12 bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-800">
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-gray-100">Авторизация</h2>
        ...
        <form method="POST" action="/login" autocomplete="off" class="space-y-5">
            @csrf
            <div>
                <label for="login" class="block text-sm font-medium mb-1 text-gray-600 dark:text-gray-300">Логин или Email</label>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input id="remember" name="remember" type="checkbox"
                           class="rounded border-gray-300 dark:bg-gray-800 text-orange-600 shadow-sm focus:ring-orange-500">
            ...
            <div class="text-center">
                <a href="/register" class="text-orange-500 hover:underline text-sm">Нет аккаунта?</a>
            </div>
        </form>
    </div>
@endsection
